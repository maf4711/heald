...
actor HealdAPI {
    ...
    private func request(path: String) async throws -> Data {
        ...
        case 200...299:
            return data
        case 401:
            throw HealdAPIError.unauthorized
        case 404:
            throw HealdAPIError.notFound
        default:
            throw HealdAPIError.serverError(http.statusCode)
        }
    }
}
...
private struct MachinesResponse: Codable {
    let machines: [MachineWithHistory]
}
