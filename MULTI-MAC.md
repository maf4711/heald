...
| | |
|---|---|
| GitHub | `maf4711/heald` |
| SSH | `git@github.com:maf4711/heald.git` |
| Remote dieses Checkouts | `git@github.com:maf4711/heald.git` |
| Ordner | `~/Developer/heald` |
| Default-Branch | `main` |

### Release

- Vercel: Verzeichnis `.`, Projekt `heald`, Team-Slug `marco-3586s-projects` (org `team_5jCZvKWdsJFJEjzTthY1ZcLA`). Production: `vercel deploy --prod --yes --scope marco-3586s-projects` in diesem Verzeichnis. `.vercel/` ist lokal; auf einem anderen Mac dasselbe Projekt mit `vercel link` verbinden.
...
3. Dieser Checkout liegt danach unter `~/Developer/heald`. Weicht der Ordner vom Repo-Namen ab, weil zwei Orgs denselben Namen haben, heißt er `~/Developer/<owner>--<name>`.
